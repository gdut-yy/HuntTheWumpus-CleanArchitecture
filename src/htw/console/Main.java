...
/**
 * Hunt the Wumpus 游戏的 Mian 组件。
 * <p>
 * 这些字符串全都是我们不想让游戏主体代码了解的内容。
 */
public class Main implements HtwMessageReceiver {
    ...
    public static void main(String[] args) throws IOException {
        // 这里传入了一个名为 htw.game.HuntTheWumpusGame 的类。
        // 由于这个类中的细节比 Man 组件还多，变更也更频繁，因此这样做可以避免这个类的变更导致 Main 组件的重新编一个重新部署
